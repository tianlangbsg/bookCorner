...
<body>
	...
	<h1 align="center">用戶登录</h1>
	<div class="container">
		<form class="form-signin" method="post" action="/book_corner/login">
			<label for="inputEmail" class="sr-only">员工号</label> <span id=error
				style="color: #F00"></span> <input type="text" value="530" onblur="checkForm()"
				id="userCode" name="userCode" class="form-control" required
				placeholder="员工号"> <label for="inputPassword"
				class="sr-only">用户名</label> <input type="text" value="王康"
	...
	<div class="container">
		<form class="form-signin" method="post" action="/book_corner/right_manage">
			<label for="manager_name" class="sr-only">员工号</label> <span id=error
				...
				placeholder="管理员用户名"> <label for="password"
				class="sr-only">用户名</label> <input type="password" value="wangkang"
				id="password" name="password" class="form-control"
				required placeholder="管理员密码">
			<button class="btn btn-lg btn-primary btn-block" type="submit">登
				录</button>
		</form>
	</div>
