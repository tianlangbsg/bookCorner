...
<body>
	...
	<h1 align="center">审核中，请等待管理员操作</h1>
	<p align="center">&nbsp;</p>
	<p align="center">&nbsp;</p>
	<div class="container">
		<form class="form-signin" action="">
			<label for="userCode" class="sr-only" value="员工号："></label> <span id=error
				style="color: #F00"></span> <input type="text" id="userCode"
				name="userCode" class="form-control" required placeholder="员工号" value="${userCode}">
			<label for="userName" class="sr-only" value="用户名："></label> <input
				type="text" id="userName" name="userName"
				class="form-control" required placeholder="用户名" value="${userName}">
			<label for="applyAt" class="sr-only" value="申请日期："></label> <input
				type="text" id="applyAt" name="applyAt"
				class="form-control" required placeholder="申请日期" value="${applyAt}">
		</form>
	</div>
	<p>&nbsp;</p>
