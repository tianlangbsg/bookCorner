		...
		<table width="80%" border="1" cellspacing="0" cellpadding="0">
			...
			<c:forEach items="${bookBorrows}" var="bookBorrow">
				<tr>
					...
					<c:if test="${bookBorrow.returnDate!=null}"><td><div align="center">${bookBorrow.returnDate}</div></td></c:if>
					<c:if test="${bookBorrow.returnDate==null}"><td><div align="center">尚未归还</div></td></c:if>
				</tr>
			</c:forEach>
		</table>
	</div>
