...
<script type="text/javascript">
	...
	function openMsgBox(that){
		var str = that.id.split("_");
		var userName = str[0];
		var userCode = str[2];
		var applyurl = "/book_corner/msgCenter?userCode="+userCode;
...
<body>
	...
	<h1 align="center">当前在线用户列表</h1>
	<br />
	<div align="center">
		<c:forEach items="${onlineUsersMap}" var="user">
			<a id="${user.value}" onclick="openMsgBox(this)">${user.value}</a>
			<br />
		</c:forEach>
	</div>
